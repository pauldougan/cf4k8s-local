> This piece of prior art is derived from the [GSP](https://github.com/alphagov/gsp) - for a while this k8s based distribution had a local incarnations that ran initially on minikube, then on kind. It is provided for historical reasons.
